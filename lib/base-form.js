...
export default class BaseForm {
  ...
  hide() {
    ...
    if (this.loading && this.loading.style.display != "none") return;
  ...
  addControl(type, name, opts = {}) {
    ...
    if (opts.value) this.setValue(name, opts.value);

    // Parent
    let parent = this.element;
    if (opts.container) parent = this.elements[opts.container];
